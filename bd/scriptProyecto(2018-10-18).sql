...
INSERT INTO `cliente` (`n_identificacion`, `tipo_documento`, `nombre`, `apellido`, `telefono`, `celular`, `direccion`, `ciudad`, `correo`, `estado`) VALUES
	(11111111, 2, 'Camilo ', 'Ochoa', '456789', '467890', 'calle 40', 2, 'camilo@hotmail.com', 'Activo'),
...
-- Volcando datos para la tabla quotevent.detalle_paquete_producto: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla quotevent.detalle_producto_suministro: ~10 rows (aproximadamente)
...
-- Volcando datos para la tabla quotevent.evento: ~2 rows (aproximadamente)
DELETE FROM `evento`;
...
INSERT INTO `evento` (`id_evento`, `solicitud_id_solicitud`, `cliente_id_cliente`, `tipo_evento`, `id_lugar`, `cantidad_personas`, `cantidad_meseros`, `hora_inicio`, `hora_fin`, `fecha`, `precio`, `observaciones`, `estado_evento`) VALUES
	(1, 3, 1030654523, 1, 1, 250, 250, '13:21:00', '22:00:00', '2018-11-20', 3500000, 'Evento matrimonial ', 4),
	...
	(4, 4, 1030654523, 1, 1, 25, 30, '08:35:00', '23:00:00', '2018-09-28', 4000000, 'prueba evento', 4),
...
INSERT INTO `producto` (`id_producto`, `nombre`, `foto`, `tipo`, `cantidad`, `medida`, `precio_unidad`, `observaciones`, `estado`) VALUES
	(22, 'arroz con pollo', 'arroz-con-pollo.jpg', 1, -240, 7, 5800, 'rico arroz con pollo', 'Activo'),
...
INSERT INTO `solicitud` (`id_solicitud`, `nombre_cliente`, `cantidad_personas`, `telefono`, `email`, `id_tipo_evento`, `id_paquete`, `hora`, `fecha`, `observaciones`, `estado`, `visto`) VALUES
	(3, 'camilo', 250, '215454', 'caparra95@misena.edu.co', 1, 5, '2 pm', '2018-09-28', 'Observaciones Observaciones ', 'Inactivo', 0),
	(4, 'andres', 10, '2315445', 'caparra95@misena.edu.co', 1, 5, '3 pm ', '2018-09-28', 'Observaciones Observaciones ', 'Inactivo', 0),
	(5, 'andres', 25, '545454', 'caparra95@misena.edu.co', 2, 10, '2 pm', '2018-09-28', 'Observaciones Observaciones ', 'Activo', 0),
	(6, 'diego', 1, '5456454', 'diego@gmail.com', 1, 11, '1100', '2018-09-28', 'deseo el combo cuero ', 'Activo', 0);
...
-- Volcando datos para la tabla quotevent.suministro: ~6 rows (aproximadamente)
...
INSERT INTO `suministro` (`id_suministro`, `nombre`, `foto`, `cantidad`, `cantidad_minima`, `medida`, `precio_unidad`, `observaciones`, `estado`) VALUES
	...
	(10, 'arroz', 'arroz.jpg', 20, 115, 1, 3500, 'leche uno mas', 'Activo'),
