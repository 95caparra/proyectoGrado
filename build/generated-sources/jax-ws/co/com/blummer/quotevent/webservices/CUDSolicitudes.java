...
@XmlRootElement(name = "CUDSolicitudes")
public class CUDSolicitudes {

    protected Integer opcion;
    @XmlElementRef(name = "solicitud", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
