...
public class EventoService {
    ...
    public int actualizarEstado(long idEvento, int estadoE, Date fecha) throws Exception {
        int resultado = -1;
        try {
            resultado = eventoDAO.modificarEstado(idEvento, estadoE, fecha);
        } catch (Exception e) {
            System.out.println(" EventoService: Se presento un error al "
    ...
    public int ultimoId() throws Exception {
        ...
        try {
            ...
            System.out.println("EventoService:"
                    + "Se presento un error al buscar el id del evento "
                    + e.getMessage());
        } finally {
            return id;
        }
