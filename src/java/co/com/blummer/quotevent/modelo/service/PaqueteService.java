...
import co.com.blummer.quotevent.webservices.ServicioPaquete;
...
public class PaqueteService {
    ...
    private static ServicioPaquete servicioPaquete;
    ...
    public int insertar(PaqueteVO paqueteVO) throws Exception {
        ...
        try {
            ...
            resultado = servicioPaquete.insertarPaquete(paqueteVO);
        } catch (Exception e) {
    ...
    public int actualizar(PaqueteVO paqueteVO) throws Exception {
        ...
        try {
            ...
            resultado = servicioPaquete.actualizarPaquete(paqueteVO);
        } catch (Exception e) {
            System.out.println("PaqueteService: Se presento un error al "
