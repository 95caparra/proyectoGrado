...
public class ProveedorService {
    ...
    public long buscarProveedorPorNombre(String razonSocial) throws Exception {
        long resultado = 0;
        try {
            resultado = proveedorDAO.buscarProveedorPorNombre(razonSocial);
        } catch (Exception e) {
            System.out.println(" ProveedorService: Se presento un error al "
                    + "actualizar un cliente:  " + e.getMessage());
        } finally {
    ...
    public ProveedorVO consultarPorId(long idProveedor) throws Exception {
        ...
        try {
            proveedorVO = proveedorDAO.consultarPorId(idProveedor);
        } catch (Exception e) {
            System.out.println("ProveedorService: Se presento un error al realizar la"
