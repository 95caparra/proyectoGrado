...
public class EmpleadoDAOMS extends ConexionMySQL implements EmpleadoDAO {
    ...
    public int insertar(EmpleadoVO empleadoVO) throws Exception {
        ...
        try {
            ...
            pstm.setLong(t++, empleadoVO.getIdentificacionEmpleado());
            pstm.setInt(t++, empleadoVO.getDocumentoVO().getIdTipoDocumento());
            pstm.setString(t++, empleadoVO.getNombre());
            pstm.setString(t++, empleadoVO.getApellido());
            pstm.setInt(t++, empleadoVO.getRolVO().getIdRol());
            pstm.setString(t++, empleadoVO.getCorreo());
            pstm.setString(t++, empleadoVO.getDireccion());
            pstm.setString(t++, empleadoVO.getTelefono());
            pstm.setString(t++, empleadoVO.getBarrio());
    ...
    public ArrayList<EmpleadoVO> listar() throws Exception {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                empleadoVO.setIdentificacionEmpleado(rs.getLong(t++));
    ...
    public String correoEmpleado(long idEmpleado) throws Exception {
        ...
        try {
            ...
            System.out.println("EmpleadoDAOMS: ocurrio un error al validar empleado"
                    + e.getMessage());
            throw e;
        } finally {
            this.desconectar();
    ...
    public ArrayList<EmpleadoVO> buscar(String parametro) throws Exception {
        ...
        try {
            ...
            System.out.println(" EmpleadoDAOMS: Se presento un ERROR al buscar en la tabla"
    ...
    @Override
    public boolean validarExistenciaEmpleado(long idEmpleado) throws Exception {
        ...
        try {
            ...
            System.out.println("EmpleadoDAOMS: Se presento un ERROR al listar la tabla empleado: " + e.getMessage());
            throw e;
        } finally {
            this.desconectar();
        }
