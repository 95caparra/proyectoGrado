...
public class PaqueteBean implements Serializable {
    ...
    private Integer cantidadesPaquete;
    ...
    public void verInformacionPaquete(Integer id) {
        ...
        try {
            ...
            RequestContext.getCurrentInstance().update("informacionPaquete");
    ...
    /**
     * @return the cantidadesPaquete
     */
    public Integer getCantidadesPaquete() {
        return cantidadesPaquete;
    }

    /**
     * @param cantidadesPaquete the cantidadesPaquete to set
     */
    public void setCantidadesPaquete(Integer cantidadesPaquete) {
        this.cantidadesPaquete = cantidadesPaquete;
    }
