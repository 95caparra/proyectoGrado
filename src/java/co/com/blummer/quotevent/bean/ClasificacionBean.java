...
public class ClasificacionBean implements Serializable {
    ...
    public void onAddNew() {
        try {
            ...
            clasificaciones = clasificacionService.listar();
            clasificaciones.add(clasificacionVO);
        } catch (Exception e) {
        }
    }
    ...
    public void onRowEdit(RowEditEvent event) {
        try {
            ...
            id = selectedClasificacion.getIdClasificacion();
            
            nombre = ((ClasificacionVO) event.getObject()).getNombre();

            boolean bandera = clasificacionService.validarExistencia(id);

            clasificacionVO = new ClasificacionVO();

            clasificacionVO.setIdClasificacion(id);
            clasificacionVO.setNombre(nombre);

            if (bandera == true) {
                clasificacionService.actualizar(clasificacionVO);
            } else {
                clasificacionService.insertar(clasificacionVO);
            }
