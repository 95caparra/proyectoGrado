...
public class ProductoBean implements Serializable {
    ...
    private Integer cantidadesProducto;
    ...
    public void insertarProducto() throws Exception {
        try {
            ...
            productoVO.getTipoProductoVO().setIdTipoProducto(selectedTipoProducto);
    ...
    public void actualizarProducto() throws Exception {
        try {
            ...
            productoVO.setPrecioUnidad(precioUnidad);
            productoVO.setObservaciones(observaciones);
            productoVO.setEstado("Activo");

            productoService.actualizar(productoVO);
    ...
    public void verInformacionProducto(Integer id) throws Exception {
        try {
            ...
            selectedTipoProducto = productoVO.getTipoProductoVO().getIdTipoProducto();
    ...
    /**
     * @return the cantidadesProducto
     */
    public Integer getCantidadesProducto() {
        return cantidadesProducto;
    }

    /**
     * @param cantidadesProducto the cantidadesProducto to set
     */
    public void setCantidadesProducto(Integer cantidadesProducto) {
