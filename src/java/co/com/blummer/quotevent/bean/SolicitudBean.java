...
public class SolicitudBean implements Serializable {
    ...
    private Integer cantidadPersonasSolicitud;
    ...
    public void consultarPorId() {
        try {
            ...
            cantidadPersonasSolicitud = solicitudVO.getCantidadPersonas();
            cantidadPersonasPaquete = solicitudVO.getPaqueteVO().getCantidadPersonas();
            fecha = solicitudVO.getFecha();
            nombreTipoEvento = solicitudVO.getTipoEventoVO().getNombreTipoEvento();
            idTipoEvento = solicitudVO.getTipoEventoVO().getIdTipoEvento();
    ...
    public void insertarSolicitud() throws Exception {
        try {
            ...
            solicitudVO.setHora(new java.sql.Time(hora.getTime()));
    ...
    /**
     * @return the cantidadPersonasSolicitud
     */
    public Integer getCantidadPersonasSolicitud() {
        return cantidadPersonasSolicitud;
    }

    /**
     * @param cantidadPersonasSolicitud the cantidadPersonasSolicitud to set
     */
    public void setCantidadPersonasSolicitud(Integer cantidadPersonasSolicitud) {
        this.cantidadPersonasSolicitud = cantidadPersonasSolicitud;
    }
