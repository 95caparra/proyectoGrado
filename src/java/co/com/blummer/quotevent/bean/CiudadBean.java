...
public class CiudadBean implements Serializable {
    ...
    public void onRowEdit(RowEditEvent event) {
        try {
            ...
            nombre = ((CiudadVO) event.getObject()).getNombreCiudad();
            
            boolean bandera = ciudadService.validarExistencia(id);
            
            ciudadVO = new CiudadVO();
            
            ciudadVO.setIdCiudad(id);
            ciudadVO.setNombreCiudad(nombre);
            
            if (bandera == true) {
                ciudadService.actualizar(ciudadVO);
            }else{
                ciudadService.insertar(ciudadVO);
            }
